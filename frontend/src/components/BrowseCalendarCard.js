      ...
      <div className="p-4 pt-8 border-t border-gray-200 ">
        <div className="flex justify-between items-center">
            <div className="flex space-x-2">
                <Link to= {`/browse-view-calendar/${id}`} className="flex items-center px-3 py-2 text-sm font-medium text-gray-900 bg-gray-100 rounded hover:bg-gray-200" >
...
export default BrowseCalendarCard;
